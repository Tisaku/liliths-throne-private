...
public class PenisBreasts {
	...
	public static final SexAction FORCE_clit_INTO_MOUTH = new SexAction(
			SexActionType.ONGOING,
			ArousalIncrease.THREE_NORMAL,
			ArousalIncrease.THREE_NORMAL,
			CorruptionLevel.ONE_VANILLA,
			Util.newHashMapOfValues(new Value<>(SexAreaPenetration.Clit, SexAreaOrifice.BREAST)),
		...
		public String getActionDescription() {
			return "Thrust your [npc.hips] forwards and force the [npc.clitHead] of your [npc.clit+] into [npc2.namePos] mouth.";
		}
...
//					&& Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()
		...
		public String getDescription() {
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Gently thrusting forwards between [npc2.namePos] [npc2.breasts],"
									+ " [npc.name] [npc.verb(push)] [npc.her] [npc.clit+] all the way up to [npc2.her] mouth and forces the [npc.clitHead] past [npc2.her] [npc2.lips].",

							"Slowly pushing [npc.her] [npc.hips] forwards, [npc.name] forces [npc.her] [npc.clit+] between [npc2.namePos] [npc2.breasts+],"
									+ " pushing all the way until the [npc.clitHead+] pushes past [npc2.her] [npc2.lips+]."));
					break;
				case DOM_NORMAL:
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							"Greedily pushing [npc.her] [npc.hips] forwards, [npc.name] forces [npc.her] [npc.clit+] between [npc2.namePos] [npc2.breasts+],"
									+ " pushing all the way until the [npc.clitHead+] pushes past [npc2.her] [npc2.lips+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly thrusting forwards between [npc2.namePos] [npc2.breasts],"
									+ " [npc.name] slams [npc.her] [npc.clit+] up against [npc2.her] mouth and forces the [npc.clitHead] past [npc2.her] [npc2.lips].",

							"Violently slamming [npc.her] [npc.hips] forwards, [npc.name] [npc.verb(thrust)] [npc.her] [npc.clit+] between [npc2.namePos] [npc2.breasts+],"
									+ " pushing all the way until the [npc.clitHead+] rams past [npc2.her] [npc2.lips+]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							"Pushing [npc.her] [npc.hips] forwards, [npc.name] forces [npc.her] [npc.clit+] between [npc2.namePos] [npc2.breasts+],"
									+ " pushing all the way until the [npc.clitHead+] pushes past [npc2.her] [npc2.lips+]."));
					break;
				case SUB_RESISTING:
					break;
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(grin)] at [npc.her] enthusiasm, and, opening [npc2.her] mouth to give the [npc.clitHead] of [npc.her] [npc.clit] a loving suck, [npc2.name] then [npc2.verb(draw)] back,"
									+ " but not before planting a kiss on the very tip.",

							" [npc2.Name] [npc2.verb(open)] [npc2.her] mouth to accept [npc.her] [npc.clit+], giving the [npc.clitHead] a hot, wet suck before drawing back to deliver a soft kiss to the very tip."));
					break;
				case DOM_NORMAL:
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(let)] out a happy [npc2.moan], and, eagerly opening [npc2.her] mouth to give the [npc.clitHead] of [npc.her] [npc.clit] a loving suck,"
									+ " [npc2.name] then [npc2.verb(draw)] back, but not before planting a wet kiss on the very tip.",

							" [npc2.Name] eagerly [npc2.verb(open)] [npc2.her] mouth to accept [npc.her] [npc.clit+], giving the [npc.clitHead] a hot, wet suck before drawing back to deliver a passionate kiss to the very tip."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+], and, quickly opening [npc2.her] mouth to give the [npc.clitHead] of [npc.her] [npc.clit] a forceful suck,"
									+ " [npc2.name] then [npc2.verb(draw)] back, but not before planting a rough kiss on the very tip.",

							" [npc2.Name] quickly [npc2.verb(open)] [npc2.her] mouth to accept [npc.her] [npc.clit+], giving the [npc.clitHead] a forceful suck before drawing back to deliver a rough kiss to the very tip."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(let)] out a little [npc2.moan], and, opening [npc2.her] mouth to give the [npc.clitHead] of [npc.her] [npc.clit] an obedient suck,"
									+ " [npc2.name] then [npc2.verb(draw)] back, but not before planting a quick kiss on the very tip.",

							" [npc2.Name] [npc2.verb(open)] [npc2.her] mouth to accept [npc.her] [npc.clit+], giving the [npc.clitHead] an obediently suck before drawing back to deliver a quick kiss to the very tip."));
					break;
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+], and, trying to pull [npc2.her] mouth away from the [npc.clitHead] of [npc.her] [npc.clit],"
									+ " [npc2.name] desperately [npc2.verb(plead)] for [npc.herHim] to leave [npc2.name] alone.",

							" [npc2.Name] [npc2.verb(jerk)] [npc2.her] head back, trying to push [npc.her] [npc.clit+] away from [npc2.her] mouth as tears [npc2.verb(start)] to well up in [npc2.her] [npc2.eyes]."));
					break;
			}
		...
		public void applyEffects() {
			Main.sex.transferLubrication(Main.sex.getCharacterPerformingAction(), SexAreaPenetration.CLIT, Main.sex.getCharacterTargetedForSexAction(this), SexAreaOrifice.MOUTH);
		}
	...
	public static final SexAction TAKE_clit_INTO_MOUTH = new SexAction(
			SexActionType.ONGOING,
			ArousalIncrease.THREE_NORMAL,
			ArousalIncrease.THREE_NORMAL,
			CorruptionLevel.ONE_VANILLA,
			Util.newHashMapOfValues(new Value<>(SexAreaOrifice.BREAST, SexAreaPenetration.CLIT)),
			SexParticipantType.NORMAL) {
		...
		@Override
		public String getActionDescription() {
			return "Push your head forwards and take the [npc2.clitHead] of [npc2.namePos] [npc2.clit+] into your mouth.";
		}
...
//					&& Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Gently pushing [npc.her] [npc.face] down towards [npc2.namePos] [npc2.clit] as it slides up between [npc.her] [npc.breasts],"
									+ " [npc.name] [npc.verb(part)] [npc.her] [npc.lips+] and [npc.verb(take)] the [npc2.clitHead] into [npc.her] mouth.",

							"Slowly pushing [npc.her] [npc.face] down,"
									+ " [npc.name] [npc.verb(take)] the [npc2.clitHead] of [npc2.namePos] [npc2.clit+] into [npc.her] mouth as [npc2.she] [npc2.verb(thrust)] up between [npc.her] [npc.breasts+]."));
					break;
				case DOM_NORMAL:
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly pushing [npc.her] [npc.face] down towards [npc2.namePos] [npc2.clit] as it slides up between [npc.her] [npc.breasts],"
									+ " [npc.name] greedily [npc.verb(part)] [npc.her] [npc.lips+] and [npc.verb(take)] the [npc2.clitHead] into [npc.her] mouth.",

							"Eagerly pushing [npc.her] [npc.face] down,"
									+ " [npc.name] greedily [npc.verb(take)] the [npc2.clitHead] of [npc2.namePos] [npc2.clit+] into [npc.her] mouth as [npc2.she] [npc2.verb(thrust)] up between [npc.her] [npc.breasts+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Pushing [npc.her] [npc.face] down towards [npc2.namePos] [npc2.clit] as it slides up between [npc.her] [npc.breasts],"
									+ " [npc.name] greedily [npc.verb(part)] [npc.her] [npc.lips+] and [npc.verb(take)] the [npc2.clitHead] into [npc.her] mouth.",
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(smile)] at [npc.her] enthusiasm, and, gently pushing [npc2.her] [npc2.clit] into [npc.her] mouth,"
									+ " [npc2.she] [npc2.verb(let)] [npc.herHim] suck and kiss the [npc2.clitHead] for a moment, before pulling back and continuing to fuck [npc.her] [npc.breasts+].",

							" [npc2.Name] slowly [npc2.verb(push)] [npc2.her] [npc2.clit+] into [npc.her] mouth,"
									+ " allowing [npc.herHim] to give the [npc2.clitHead] a hot, wet suck before drawing back and continuing to fuck [npc.her] [npc.breasts+]."));
					break;
				case DOM_NORMAL:
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(grin)] at [npc2.her] enthusiasm, and, eagerly pushing [npc2.her] [npc2.clit] into [npc.namePos] mouth,"
									+ " [npc2.she] [npc2.verb(let)] [npc.herHim] suck and kiss the [npc2.clitHead] for a moment, before pulling back and continuing to fuck [npc.her] [npc.breasts+].",

							" [npc2.Name] eagerly [npc2.verb(push)] [npc2.her] [npc2.clit+] into [npc.her] mouth,"
									+ " allowing [npc.herHim] to give the [npc2.clitHead] a hot, wet suck before drawing back and continuing to fuck [npc.her] [npc.breasts+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(grin)] at [npc2.her] enthusiasm, and, roughly forcing [npc2.her] [npc2.clit] deeper into [npc.namePos] mouth,"
									+ " [npc2.she] allows [npc.herHim] to suck and kiss the [npc2.clitHead] for a moment, before pulling back and continuing to aggressively fuck [npc.her] [npc.breasts+].",

							" [npc2.Name] roughly [npc2.verb(force)] [npc2.her] [npc2.clit+] into [npc.her] mouth,"
									+ " allowing [npc.herHim] to give the [npc2.clitHead] a hot, wet suck before drawing back and continuing to aggressively fuck [npc.namePos] [npc.breasts+]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(let)] out a little [npc2.moan], and, pushing [npc2.her] [npc2.clit] into [npc.namePos] mouth, [npc2.she] gasps as [npc.name] suck and kiss the [npc2.clitHead] for a moment,"
									+ " before allowing [npc2.herHim] to pull back and [npc2.verb(continue)] to fuck [npc.her] [npc.breasts+].",

							" [npc2.Name] [npc2.verb(push)] [npc2.her] [npc2.clit+] into [npc.her] mouth,"
									+ " gasping as [npc.she] [npc.verb(give)] the [npc2.clitHead] a hot, wet suck before allowing [npc2.herHim] to pull back and [npc2.verb(continue)] to fuck [npc.her] [npc.breasts+]."));
					break;
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(let)] out [npc.a_moan+], and, trying to pull [npc2.her] [npc2.clit] away from [npc.namePos] mouth,"
							...
							" [npc2.Name] [npc2.verb(try)] to pull [npc2.her] [npc2.hips] back, but [npc.name] [npc.verb(hold)] [npc2.herHim] in place,"
									+ " sucking on the [npc2.clitHead] of [npc2.her] [npc2.clit+] for a moment before finally letting [npc2.herHim] pull away."));
					break;
			}
		...
		@Override
		public void applyEffects() {
			Main.sex.transferLubrication(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.CLIT, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.MOUTH);
		}
	...
	public static final SexAction FUCKING_START = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()) {
				return "Slide your [npc.clit+] between [npc2.namePos] [npc2.breasts+] and start fucking them.";
			} else {
				return "Start grinding your [npc.clit+] over [npc2.namePos] chest.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()) {
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to take hold of [npc2.namePos] [npc2.breasts+], [npc.name] gently [npc.verb(push)] them together,"
										+ " lining [npc.her] [npc.clit] up to [npc2.her] cleavage before sliding forwards and starting to fuck [npc2.her] [npc2.breasts]."));
						break;
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to greedily sink [npc.her] [npc.fingers] into [npc2.namePos] [npc2.breasts+], [npc.name] eagerly [npc.verb(push)] them together,"
										+ " lining [npc.her] [npc.clit] up to [npc2.her] cleavage before sliding forwards and starting to enthusiastically fuck [npc2.her] [npc2.breasts]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to roughly sink [npc.her] [npc.fingers] into [npc2.namePos] [npc2.breasts+], [npc.name] forcefully [npc.verb(push)] them together,"
										+ " lining [npc.her] [npc.clit] up to [npc2.her] cleavage before slamming forwards and starting to rapidly fuck [npc2.her] [npc2.breasts]."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to take hold of [npc2.namePos] [npc2.breasts+], [npc.name] gently [npc.verb(try)] to push them together,"
										+ " lining [npc.her] [npc.clit] up to what little cleavage [npc2.she] [npc2.has] before sliding forwards and starting to grind down over [npc2.her] chest."));
						break;
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to squeeze and grope [npc2.namePos] [npc2.breasts+], [npc.name] [npc.do] [npc.her] best to try to push them together,"
										+ " lining [npc.her] [npc.clit] up to what little cleavage [npc2.she] [npc2.has] before sliding forwards and starting to eagerly grind down over [npc2.her] chest."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to roughly squeeze and grope [npc2.namePos] [npc2.breasts+], [npc.name] [npc.do] [npc.her] best to try to push them together,"
										+ " lining [npc.her] [npc.clit] up to what little cleavage [npc2.she] [npc2.has] before sliding forwards and starting to forcefully grind down over [npc2.her] chest."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to squeeze and grope [npc2.namePos] [npc2.breasts+], [npc.name] [npc.do] [npc.her] best to try to push them together,"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to press [npc.her] [npc.hands] against [npc2.namePos] torso, [npc.name] repositions [npc.herself] to line [npc.her] [npc.clit] up over [npc2.her] chest,"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to roughly [npc.verb(press)] [npc.her] [npc.hands] against [npc2.namePos] torso, [npc.name] repositions [npc.herself] to line [npc.her] [npc.clit] up over [npc2.her] chest,"
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_moan+] bursts out from between [npc2.namePos] [npc2.lips+],"
									...
									+ " [npc2.she] [npc2.verb(encourage)] [npc.name] to continue sliding [npc.her] [npc.clit+] up and down between [npc2.her] cleavage.",
		
							" [npc2.Moaning] in delight, [npc2.name] eagerly [npc2.verb(wrap)] [npc2.her] [npc2.breasts+] around [npc.namePos] [npc.clit+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] [npc2.verb(wrap)] [npc2.her] [npc2.breasts+] around [npc.namePos] [npc.clit+],"
									+ " before begging for [npc.herHim] to continue fucking [npc2.her] pillowy mounds."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] gently [npc2.verb(wrap)] [npc2.her] [npc2.breasts+] around [npc.namePos] [npc.clit+],"
									+ " before begging for [npc.herHim] to continue fucking [npc2.her] pillowy mounds."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_moan+] bursts out from between [npc2.namePos] [npc2.lips+],"
									...
									+ " [npc2.she] [npc2.verb(order)] [npc.name] to continue thrusting [npc.her] [npc.clit+] up and down between [npc2.her] cleavage.",
		
							" [npc2.Moaning] in delight, [npc2.name] dominantly [npc2.verb(wrap)] [npc2.her] [npc2.breasts+] around [npc.namePos] [npc.clit+],"
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_moan+] bursts out from between [npc2.namePos] [npc2.lips+],"
									...
									+ " [npc2.she] [npc2.verb(encourage)] [npc.name] to continue sliding [npc.her] [npc.clit+] up and down between [npc2.her] tiny cleavage.",
		
							" [npc2.Moaning] in delight, [npc2.name] eagerly [npc2.verb(push)] [npc2.her] [npc2.breasts+] against the sides of [npc.namePos] [npc.clit+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] [npc2.verb(push)] [npc2.her] [npc2.breasts+] against the sides of [npc.namePos] [npc.clit+],"
									+ " before begging for [npc.herHim] to continue fucking [npc2.her] diminutive cleavage."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] gently [npc2.verb(push)] [npc2.her] [npc2.breasts+] against the sides of [npc.namePos] [npc.clit+],"
									+ " before begging for [npc.herHim] to continue fucking [npc2.her] diminutive cleavage."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_moan+] bursts out from between [npc2.namePos] [npc2.lips+],"
									+ " and, forcefully pressing [npc2.her] [npc2.breastSize] [npc2.breasts] together,"
									+ " [npc2.she] [npc2.verb(order)] [npc.name] to continue thrusting [npc.her] [npc.clit+] up and down between [npc2.her] tiny cleavage.",
		
							" [npc2.Moaning] in delight, [npc2.name] dominantly [npc2.verb(press)] [npc2.her] [npc2.breasts+] against the sides of [npc.namePos] [npc.clit+],"
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_moan+] bursts out from between [npc2.namePos] [npc2.lips+],"
									...
									+ " [npc2.she] [npc2.verb(encourage)] [npc.name] to continue sliding [npc.her] [npc.clit+] up and down over [npc2.her] torso.",
		
							" [npc2.Moaning] in delight, [npc2.name] eagerly [npc2.does] [npc2.her] best to try and [npc2.verb(wrap)] [npc2.her] flat chest around [npc.namePos] [npc.clit+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] [npc2.does] [npc2.her] best to try and [npc2.verb(wrap)] [npc2.her] flat chest around [npc.namePos] [npc.clit+],"
									+ " before giving up and begging for [npc.herHim] to continue humping [npc2.her] torso."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] [npc2.does] [npc2.her] best to try and gently [npc2.verb(wrap)] [npc2.her] flat chest around [npc.namePos] [npc.clit+],"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_moan+] bursts out from between [npc2.namePos] [npc2.lips+],"
									...
									+ " [npc2.she] [npc2.verb(order)] [npc.name] to continue thrusting [npc.her] [npc.clit+] up and down over [npc2.her] torso.",

							" [npc2.Moaning] in delight, [npc2.name] [npc2.does] [npc2.her] best to try and roughly [npc2.verb(wrap)] [npc2.her] flat chest around [npc.namePos] [npc.clit+],"
	...
	public static final SexAction FUCKING_DOM_GENTLE = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()) {
				...
				return "Gently grind your [npc.clit+] against [npc2.namePos] flat chest.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Gently sliding [npc.her] [npc.clit+] between [npc2.namePos] [npc2.breasts+],"
						...
						"Gently pushing [npc.her] [npc.clit+] between the cleavage formed between [npc2.namePos] [npc2.breasts+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Gently sliding [npc.her] [npc.clit+] between [npc2.namePos] tiny [npc2.breasts],"
						...
						"Gently pushing [npc.her] [npc.clit+] between the tiny amount of cleavage formed between [npc2.namePos] [npc2.breasts+],"
						...
						"Softly trying to push [npc2.namePos] [npc2.breastSize] [npc2.breasts] together, [npc.name] [npc.verb(let)] out a little [npc.moan] as [npc.she] [npc.verb(start)] to gently pump [npc.her] [npc.hips] back and forth,"
								+ " breathing in [npc2.her] [npc2.scent] as [npc.she] slowly [npc.verb(grind)] [npc.her] [npc.clit+] over [npc2.her] chest."));
				
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Gently sliding [npc.her] [npc.clit+] over [npc2.namePos] flat chest,"
						...
						"Gently pushing [npc.her] [npc.clit+] down against [npc2.namePos] flat [npc2.breasts],"
								+ " [npc.name] [npc.verb(start)] softly thrusting [npc.her] [npc.hips] forwards, letting out a little [npc.moan] as [npc.she] gently [npc.verb(grind)] up and down over [npc2.her] chest.",
						...
						"Softly groping [npc2.namePos] flat chest, [npc.name] [npc.verb(let)] out a little [npc.moan] as [npc.she] [npc.verb(start)] to gently pump [npc.her] [npc.hips] back and forth,"
								+ " breathing in [npc2.her] [npc2.scent] as [npc.she] slowly [npc.verb(grind)] [npc.her] [npc.clit+] over [npc2.her] torso."));
			}
	...
	public static final SexAction FUCKING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Eagerly sliding [npc.her] [npc.clit+] between [npc2.namePos] [npc2.breasts+],"
						...
						"Desperately pushing [npc.her] [npc.clit+] between the cleavage formed between [npc2.namePos] [npc2.breasts+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Eagerly sliding [npc.her] [npc.clit+] between [npc2.namePos] tiny [npc2.breasts],"
						...
						"Desperately pushing [npc.her] [npc.clit+] between the tiny amount of cleavage formed between [npc2.namePos] [npc2.breasts+],"
						...
						"Greedily trying to push [npc2.namePos] [npc2.breastSize] [npc2.breasts] together, [npc.name] [npc.verb(let)] out [npc.a_moan+] as [npc.she] [npc.verb(start)] to frantically pump [npc.her] [npc.hips] back and forth,"
								+ " breathing in [npc2.her] [npc2.scent] as [npc.she] eagerly [npc.verb(grind)] [npc.her] [npc.clit+] over [npc2.her] chest."));
				
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Eagerly sliding [npc.her] [npc.clit+] over [npc2.namePos] flat chest,"
						...
						"Desperately pushing [npc.her] [npc.clit+] down against [npc2.namePos] flat [npc2.breasts],"
								+ " [npc.name] [npc.verb(start)] energetically thrusting [npc.her] [npc.hips] forwards, letting out [npc.moans+] as [npc.she] happily [npc.verb(grind)] up and down over [npc2.her] chest.",
						...
						"Greedily groping [npc2.namePos] flat chest, [npc.name] [npc.verb(let)] out [npc.a_moan+] as [npc.she] [npc.verb(start)] to frantically pump [npc.her] [npc.hips] back and forth,"
								+ " breathing in [npc2.her] [npc2.scent] as [npc.she] eagerly [npc.verb(grind)] [npc.her] [npc.clit+] over [npc2.her] torso."));
			}
	...
	public static final SexAction FUCKING_DOM_ROUGH = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()) {
				...
				return "Roughly grind your [npc.clit+] against [npc2.namePos] flat chest.";
			}
		}
		@Override
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Roughly slamming [npc.her] [npc.clit+] between [npc2.namePos] [npc2.breasts+],"
						...
						"Violently pushing [npc.her] [npc.clit+] between the cleavage formed between [npc2.namePos] [npc2.breasts+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Roughly slamming [npc.her] [npc.clit+] between [npc2.namePos] tiny [npc2.breasts],"
						...
						"Violently pushing [npc.her] [npc.clit+] between the tiny amount of cleavage formed between [npc2.namePos] [npc2.breasts+],"
						...
						"Greedily trying to push [npc2.namePos] [npc2.breastSize] [npc2.breasts] together, [npc.name] [npc.verb(let)] out [npc.a_moan+] as [npc.she] [npc.verb(start)] to dominantly pump [npc.her] [npc.hips] back and forth,"
								+ " breathing in [npc2.her] [npc2.scent] as [npc.she] roughly [npc.verb(grind)] [npc.her] [npc.clit+] over [npc2.her] chest."));
				
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Roughly pushing [npc.her] [npc.clit+] over [npc2.namePos] flat chest,"
						...
						"Violently pushing [npc.her] [npc.clit+] down against [npc2.namePos] flat [npc2.breasts],"
								+ " [npc.name] [npc.verb(start)] roughly thrusting [npc.her] [npc.hips] forwards, letting out [npc.moans+] as [npc.she] dominantly [npc.verb(grind)] up and down over [npc2.her] chest.",
						...
						"Greedily groping [npc2.namePos] flat chest, [npc.name] [npc.verb(let)] out [npc.a_moan+] as [npc.she] [npc.verb(start)] to dominantly pump [npc.her] [npc.hips] back and forth,"
								+ " breathing in [npc2.her] [npc2.scent] as [npc.she] roughly [npc.verb(grind)] [npc.her] [npc.clit+] over [npc2.her] torso."));
			}
	...
	public static final SexAction FUCKING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Sliding [npc.her] [npc.clit+] between [npc2.namePos] [npc2.breasts+],"
						...
						"Pushing [npc.her] [npc.clit+] between the cleavage formed between [npc2.namePos] [npc2.breasts+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Sliding [npc.her] [npc.clit+] between [npc2.namePos] tiny [npc2.breasts],"
						...
						"Pushing [npc.her] [npc.clit+] between the tiny amount of cleavage formed between [npc2.namePos] [npc2.breasts+],"
						...
						"Trying to push [npc2.namePos] [npc2.breastSize] [npc2.breasts] together, [npc.name] [npc.verb(let)] out [npc.a_moan+] as [npc.she] [npc.verb(start)] to pump [npc.her] [npc.hips] back and forth,"
								+ " breathing in [npc2.her] [npc2.scent] as [npc.she] [npc.verb(grind)] [npc.her] [npc.clit+] over [npc2.her] chest."));
				
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Sliding [npc.her] [npc.clit+] over [npc2.namePos] flat chest,"
						...
						"Pushing [npc.her] [npc.clit+] down against [npc2.namePos] flat [npc2.breasts],"
								+ " [npc.name] [npc.verb(start)] thrusting [npc.her] [npc.hips] forwards, letting out [npc.moans+] as [npc.she] happily [npc.verb(grind)] up and down over [npc2.her] chest.",
						...
						"Groping [npc2.namePos] flat chest, [npc.name] [npc.verb(let)] out [npc.a_moan+] as [npc.she] [npc.verb(start)] to pump [npc.her] [npc.hips] back and forth,"
								+ " breathing in [npc2.her] [npc2.scent] as [npc.she] [npc.verb(grind)] [npc.her] [npc.clit+] over [npc2.her] torso."));
			}
	...
	public static final SexAction FUCKING_SUB_RESIST = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()) {
				return "Try to pull your [npc.clit] away from [npc2.namePos] [npc2.breasts+].";
			} else {
				return "Try to pull your [npc.clit] away from [npc2.namePos] chest.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] desperately [npc.verb(try)] to pull [npc.her] [npc.clit+] out of [npc2.namePos] cleavage, but [npc2.she] firmly [npc2.verb(hold)] [npc.herHim] in place,"
								...
								"Tears start to well up in [npc.namePos] [npc.eyes] as [npc.she] [npc.verb(try)] to pull out of [npc2.namePos] cleavage, but [npc2.her] grip is too strong,"
										+ " and [npc2.she] [npc2.verb(continue)] softly [npc2.moaning] as [npc2.she] firmly [npc2.verb(force)] [npc.her] [npc.clit+] between [npc2.her] [npc2.breasts+]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] desperately [npc.verb(try)] to pull [npc.her] [npc.clit+] out of [npc2.namePos] cleavage, but [npc2.she] roughly [npc2.verb(hold)] [npc.herHim] in place,"
								...
								"Tears start to well up in [npc.namePos] [npc.eyes] as [npc.she] [npc.verb(try)] to pull out of [npc2.namePos] cleavage, but [npc2.her] grip is too strong,"
										+ " and [npc2.she] [npc2.verb(continue)] [npc2.moaning+] as [npc2.she] roughly [npc2.verb(force)] [npc.her] [npc.clit+] between [npc2.her] [npc2.breasts+]."));
						break;
					default: // DOM_NORMAL and in case anything goes wrong:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								"Tears start to well up in [npc.namePos] [npc.eyes] as [npc.she] [npc.verb(try)] to pull out of [npc2.namePos] cleavage, but [npc2.her] grip is too strong,"
										+ " and [npc2.she] [npc2.verb(continue)] [npc2.moaning+] as [npc2.she] eagerly [npc2.verb(force)] [npc.her] [npc.clit+] between [npc2.her] [npc2.breasts+]."));
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] desperately [npc.verb(try)] to pull [npc.her] [npc.clit+] out of the small amount of cleavage that [npc2.name] [npc2.has], but [npc2.she] firmly [npc2.verb(hold)] [npc.herHim] in place,"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] desperately [npc.verb(try)] to pull [npc.her] [npc.clit+] out of the small amount of cleavage that [npc2.name] [npc2.has], but [npc2.she] roughly [npc2.verb(hold)] [npc.herHim] in place,"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] desperately [npc.verb(try)] to pull [npc.her] [npc.clit+] away from [npc2.namePos] flat chest, but [npc2.she] firmly [npc2.verb(hold)] [npc.herHim] in place,"
								...
								"Tears start to well up in [npc.namePos] [npc.eyes] as [npc.she] [npc.verb(try)] to pull away from [npc2.name], but [npc2.her] grip is too strong,"
										+ " and [npc2.she] [npc2.verb(continue)] softly [npc2.moaning] as [npc2.she] firmly [npc2.verb(force)] [npc.her] [npc.clit+] against [npc2.her] chest."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] desperately [npc.verb(try)] to pull [npc.her] [npc.clit+] away from [npc2.namePos] chest, but [npc2.she] roughly [npc2.verb(hold)] [npc.herHim] in place,"
								...
								"Tears start to well up in [npc.namePos] [npc.eyes] as [npc.she] [npc.verb(try)] to pull away from [npc2.name], but [npc2.her] grip is too strong,"
										+ " and [npc2.she] [npc2.verb(continue)] [npc2.moaning+] as [npc2.she] roughly [npc2.verb(force)] [npc.namePos] [npc.clit+] against [npc2.her] chest."));
						break;
					default: // DOM_NORMAL and in case anything goes wrong:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] desperately [npc.verb(try)] to pull [npc.her] [npc.clit+] away from [npc2.namePos] chest, but [npc2.name] firmly [npc2.verb(hold)] [npc.herHim] in place,"
								...
								"Tears start to well up in [npc.namePos] [npc.eyes] as [npc.she] [npc.verb(try)] to pull away from [npc2.name], but [npc2.her] grip is too strong,"
										+ " and [npc2.she] [npc2.verb(continue)] [npc2.moaning+] as [npc2.she] eagerly [npc2.verb(force)] [npc.her] [npc.clit+] against [npc2.her] chest."));
						break;
				}
			}
	...
	public static final SexAction FUCKING_STOP = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()) {
				return "Pull your [npc.clit+] away from [npc2.namePos] [npc2.breasts+] and stop fucking them.";
			} else {
				return "Pull your [npc.clit+] away from [npc2.namePos] chest and stop grinding against [npc2.herHim].";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastFuckablePaizuri()) {
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly pushing [npc2.name] away,"
										+ " [npc.name] [npc.verb(pull)] [npc.her] [npc.clit+] out from [npc2.her] cleavage and [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of fucking [npc2.her] [npc2.breasts+].",

								"Roughly pulling [npc.her] [npc.clit+] out from [npc2.namePos] cleavage, [npc.name] [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of fucking [npc2.her] [npc2.breasts+]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.name] [npc.verb(pull)] [npc.her] [npc.clit+] out from [npc2.namePos] cleavage and [npc.verb(tell)] [npc2.name] that [npc.sheHas] had enough of fucking [npc2.her] [npc2.breasts+].",

								"Pulling [npc.her] [npc.clit+] out from [npc2.namePos] cleavage, [npc.name] [npc.verb(tell)] [npc2.name] that [npc.sheHas] had enough of fucking [npc2.her] [npc2.breasts+]."));
						break;
				}
			} else if(Main.sex.getCharacterTargetedForSexAction(this).hasBreasts()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly pushing [npc2.name] away, [npc.name] [npc.verb(pull)] [npc.her] [npc.clit+] out from [npc2.her] tiny amount of cleavage"
										+ " and [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of fucking [npc2.her] [npc2.breastSize] [npc2.breasts].",

								"Roughly pulling [npc.her] [npc.clit+] out from [npc2.namePos] tiny amount of cleavage,"
										+ " [npc.name] [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of fucking [npc2.her] [npc2.breastSize] [npc2.breasts]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.name] [npc.verb(pull)] [npc.her] [npc.clit+] out from [npc2.namePos] tiny amount of cleavage"
										+ " and [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of fucking [npc2.her] [npc2.breastSize] [npc2.breasts].",

								"Pulling [npc.her] [npc.clit+] out from [npc2.namePos] tiny amount of cleavage,"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly pushing [npc2.name] away, [npc.name] takes [npc.her] [npc.clit+] away from [npc2.her] chest and [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of grinding against [npc2.herHim].",

								"Roughly pulling [npc.her] [npc.clit+] away from [npc2.namePos] chest, [npc.name] [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of grinding against [npc2.herHim]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] takes [npc.her] [npc.clit+] away from [npc2.namePos] chest and [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of grinding against [npc2.herHim].",

								"Pulling [npc.her] [npc.clit+] away from [npc2.namePos] chest, [npc.name] [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of grinding against [npc2.herHim]."));
						break;
				}
			}
	...
	public static final SexAction USING_clit_START = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				return "Use [npc2.namePos] [npc2.clit+] to fuck [npc.namePos] [npc.breasts+].";
			} else {
				return "Use [npc2.namePos] [npc2.clit+] to grind against your chest.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Gently taking hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to [npc.her] cleavage, and, sliding forwards,"
								+ " [npc.she] [npc.verb(press)] [npc.her] [npc.breasts+] together and [npc.verb(start)] giving [npc2.herHim] a titfuck."));
						break;
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Eagerly taking hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to [npc.her] cleavage, and, sliding forwards,"
								+ " [npc.she] [npc.verb(press)] [npc.her] [npc.breasts+] together and [npc.verb(start)] giving [npc2.herHim] an enthusiastic titfuck."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly grabbing hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(pull)] it up to [npc.her] cleavage, and, sliding forwards,"
								+ " [npc.she] [npc.verb(press)] [npc.her] [npc.breasts+] together and [npc.verb(start)] giving [npc2.herHim] a forceful titfuck."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Taking hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to [npc.her] cleavage, and, sliding forwards,"
								+ " [npc.she] [npc.verb(press)] [npc.her] [npc.breasts+] together and [npc.verb(start)] giving [npc2.herHim] a titfuck."));
						break;
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Gently taking hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to what little cleavage [npc.she] [npc.has], and, sliding forwards,"
					...
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Eagerly taking hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to what little cleavage [npc.she] [npc.has], and, sliding forwards,"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly grabbing hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to what little cleavage [npc.she] [npc.has], and, sliding forwards,"
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Taking hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to what little cleavage [npc.she] [npc.has], and, sliding forwards,"
										+ " [npc.she] [npc.verb(try)] [npc.her] best to press [npc.her] [npc.breastSize] [npc.breasts] together in order to give [npc2.herHim] a titfuck."));
						break;
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Gently taking hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to [npc.her] flat chest, and, sliding forwards,"
										+ " [npc.she] [npc.verb(grind)] [npc.her] torso against [npc2.her] [npc2.clit+]."));
						break;
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Eagerly taking hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to [npc.her] flat chest, and, sliding forwards,"
										+ " [npc.she] enthusiastically [npc.verb(grind)] [npc.her] torso against [npc2.her] [npc2.clit+]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly grabbing hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to [npc.her] flat chest, and, sliding forwards,"
										+ " [npc.she] forcefully [npc.verb(grind)] [npc.her] torso against [npc2.her] [npc2.clit+]."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Taking hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to [npc.her] flat chest, and, sliding forwards,"
										+ " [npc.she] [npc.verb(grind)] [npc.her] torso against [npc2.her] [npc2.clit+]."));
						break;
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
	...
	private static String getTargetedCharacterReceivingResponse(SexAction action) {
		if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] greedily [npc2.verb(thrust)] [npc2.her] [npc2.clit+] deep between [npc.namePos] [npc.breasts+],"
									+ " letting out [npc2.a_moan+] as [npc2.she] enthusiastically [npc2.verb(fuck)] [npc.her] cleavage.",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] thrusting [npc2.her] [npc2.clit+] deep between [npc.namePos] [npc.breasts+].",
									
							" [npc2.Moaning] in delight, [npc2.name] eagerly [npc2.verb(drive)] [npc2.her] [npc2.clit+] in and out between [npc.namePos] [npc.breasts+]."));
					break;
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" Failing to pull [npc2.her] [npc2.clit] away from [npc.namePos] [npc.breasts+],"
									+ " [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc2.she] weakly [npc2.verb(try)] to struggle free.",
		
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
									+ " squirming and protesting as [npc.name] [npc.verb(continue)] to force [npc2.her] [npc2.clit+] back and forth between [npc.her] [npc.breasts+].",
		
							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to pull [npc2.her] [npc2.clit] away from [npc.namePos] [npc.breasts+]."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] gently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] between [npc.namePos] [npc.breasts+],"
									+ " letting out a soft [npc2.moan] as [npc2.she] [npc2.verb(fuck)] [npc.her] cleavage.",
		
							" A soft [npc2.moan] drifts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] gently thrusting [npc2.her] [npc2.clit+] between [npc.namePos] [npc.breasts+].",
									
							" [npc2.Moaning] in delight, [npc2.name] gently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] back and forth between [npc.namePos] [npc.breasts+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] violently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] deep between [npc.namePos] [npc.breasts+],"
									+ " letting out [npc2.a_moan+] as [npc2.she] roughly [npc2.verb(fuck)] [npc.her] cleavage.",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] roughly slamming [npc2.her] [npc2.clit+] deep between [npc.namePos] [npc.breasts+].",
									
							" [npc2.Moaning] in delight, [npc2.name] roughly [npc2.verb(slam)] [npc2.her] [npc2.clit+] back and forth between [npc.namePos] [npc.breasts+]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(thrust)] [npc2.her] [npc2.clit+] deep between [npc.namePos] [npc.breasts+],"
									+ " letting out [npc2.a_moan+] as [npc2.she] [npc2.verb(fuck)] [npc.her] cleavage.",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] thrusting [npc2.her] [npc2.clit+] deep between [npc.namePos] [npc.breasts+].",
									
							" [npc2.Moaning] in delight, [npc2.name] [npc2.verb(drive)] [npc2.her] [npc2.clit+] back and forth between [npc.namePos] [npc.breasts+]."));
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] greedily [npc2.verb(thrust)] [npc2.her] [npc2.clit+] into what little cleavage [npc.name] [npc.has] to offer,"
									+ " letting out [npc2.a_moan+] as [npc2.she] enthusiastically [npc2.verb(fuck)] [npc.her] [npc.breasts+].",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] thrusting [npc2.her] [npc2.clit+] between [npc.namePos] [npc.breastSize] [npc.breasts].",
									
							" [npc2.Moaning] in delight, [npc2.name] eagerly [npc2.verb(drive)] [npc2.her] [npc2.clit+] in and out of the diminutive cleavage formed between [npc.namePos] [npc.breasts+]."));
					break;
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" Failing to pull [npc2.her] [npc2.clit] away from [npc.namePos] [npc.breasts+],"
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] gently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] into what little cleavage [npc.name] [npc.has] to offer,"
									+ " letting out a soft [npc2.moan] as [npc2.she] [npc2.verb(fuck)] [npc.her] [npc.breasts+].",
		
							" A soft [npc2.moan] drifts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] gently thrusting [npc2.her] [npc2.clit+] between [npc.namePos]  [npc.breastSize] [npc.breasts].",
									
							" [npc2.Moaning] in delight, [npc2.name] gently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] in and out of the diminutive cleavage formed between [npc.namePos] [npc.breasts+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] violently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] into what little cleavage [npc.name] [npc.has] to offer,"
									+ " letting out [npc2.a_moan+] as [npc2.she] roughly [npc2.verb(fuck)] [npc.her] [npc.breasts+].",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] roughly slamming [npc2.her] [npc2.clit+] between  [npc.breastSize] [npc.breasts].",
									
							" [npc2.Moaning] in delight, [npc2.name] roughly [npc2.verb(slam)] [npc2.her] [npc2.clit+] in and out of the diminutive cleavage formed between [npc.namePos] [npc.breasts+]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(thrust)] [npc2.her] [npc2.clit+] into what little cleavage [npc.name] [npc.has] to offer,"
									+ " letting out [npc2.a_moan+] as [npc2.she] [npc2.verb(fuck)] [npc.her] [npc.breasts+].",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] thrusting [npc2.her] [npc2.clit+] between  [npc.breastSize] [npc.breasts].",
									
							" [npc2.Moaning] in delight, [npc2.name] [npc2.verb(drive)] [npc2.her] [npc2.clit+] in and out of the diminutive cleavage formed between [npc.namePos] [npc.breasts+]."));
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] greedily [npc2.verb(thrust)] [npc2.her] [npc2.clit+] over [npc.namePos] flat chest,"
									+ " letting out [npc2.a_moan+] as [npc2.she] enthusiastically [npc2.verb(grind)] against [npc.her] torso.",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] thrusting [npc2.her] [npc2.clit+] up and down against [npc.namePos] flat chest.",
									
							" [npc2.Moaning] in delight, [npc2.name] eagerly [npc2.verb(grind)] [npc2.her] [npc2.clit+] over [npc.namePos] flat chest."));
					break;
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" Failing to pull [npc2.her] [npc2.clit] away from [npc.namePos] flat chest,"
									+ " [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc2.she] weakly [npc2.verb(try)] to struggle free.",
		
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
									+ " squirming and protesting as [npc.name] [npc.verb(continue)] to force [npc2.her] [npc2.clit+] back and forth over [npc.her] flat chest.",
		
							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to pull [npc2.her] [npc2.clit] away from [npc.namePos] flat chest."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] gently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] over [npc.namePos] flat chest,"
									+ " letting out a soft [npc2.moan] as [npc2.she] [npc2.verb(grind)] against [npc.her] torso.",
		
							" A soft [npc2.moan] drifts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] gently thrusting [npc2.her] [npc2.clit+] up and down against [npc.namePos] flat chest.",
									
							" [npc2.Moaning] in delight, [npc2.name] gently [npc2.verb(grind)] [npc2.her] [npc2.clit+] over [npc.namePos] flat chest."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] violently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] over [npc.namePos] flat chest,"
									+ " letting out [npc2.a_moan+] as [npc2.she] roughly [npc2.verb(grind)] against [npc.her] torso.",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] roughly slamming [npc2.her] [npc2.clit+] up and down against [npc.namePos] flat chest.",
									
							" [npc2.Moaning] in delight, [npc2.name] roughly [npc2.verb(grind)] [npc2.her] [npc2.clit+] over [npc.namePos] flat chest."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(thrust)] [npc2.her] [npc2.clit+] over [npc.namePos] flat chest,"
									+ " letting out [npc2.a_moan+] as [npc2.she] [npc2.verb(grind)] against [npc.her] torso.",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] thrusting [npc2.her] [npc2.clit+] up and down against [npc.namePos] flat chest.",
									
							" [npc2.Moaning] in delight, [npc2.name] [npc2.verb(grind)] [npc2.her] [npc2.clit+] over [npc.namePos] flat chest."));
					break;
			}
		}
		return "";
	...
	public static final SexAction PERFORMING_clit_DOM_GENTLE = new SexAction(
			SexActionType.ONGOING,
			ArousalIncrease.FOUR_HIGH,
			ArousalIncrease.FOUR_HIGH,
			CorruptionLevel.ONE_VANILLA,
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				return "Gently pleasure [npc2.namePos] [npc2.clit+] with your [npc.breasts+].";
			} else {
				return "Gently pleasure [npc2.namePos] [npc2.clit+] with your chest.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Reaching up to push [npc.her] [npc.breasts+] together around [npc2.namePos] [npc2.clit+],"
						...
						"Gently wrapping [npc.her] [npc.breasts+] around [npc2.namePos] [npc2.clit+], [npc.name] slowly [npc.verb(lift)] them up and down,"
						...
						"Letting out a soft [npc.moan], [npc.name] [npc.verb(push)] [npc.her] [npc.breasts+] together,"
								+ " enveloping [npc2.namePos] [npc2.clit+] in [npc.her] pillowy mounds as [npc.she] [npc.verb(give)] [npc2.herHim] a loving titfuck."));
				
			} else {
				if(Main.sex.getCharacterPerformingAction().hasBreasts()) {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to push [npc.her] [npc.breasts+] against the sides of [npc2.namePos] [npc2.clit+],"
							...
							"Gently pressing [npc.her] [npc.breastSize] [npc.breasts] against the sides of [npc2.namePos] [npc2.clit+], [npc.name] slowly [npc.verb(lift)] them up and down,"
									+ " letting out a soft [npc.moan] as [npc.she] lovingly [npc.verb(attempt)] to give [npc2.herHim] a titfuck.",

							"Letting out a soft [npc.moan], [npc.name] [npc.verb(push)] [npc.her] [npc.breasts+] together,"
									+ " trying [npc.her] best to pleasure [npc2.namePos] [npc2.clit+] with the tiny amount of cleavage [npc.she] [npc.has]."));
					
				} else {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to wrap [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+], [npc.name] gently [npc.verb(raise)] and [npc.verb(lower)] [npc.her] torso,"
									+ " softly [npc.moaning] as [npc.she] [npc.verb(thrust)] out [npc.her] flat chest and [npc.verb(grind)] against [npc2.herHim].",

							"Gently wrapping [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(lift)] [npc.her] torso up and down,"
									+ " grinding [npc.her] flat chest against [npc2.herHim] as [npc.she] [npc.verb(try)] to imitate giving [npc2.herHim] a titfuck.",

							"Letting out a soft [npc.moan], [npc.name] [npc.verb(wrap)] [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+],"
	...
	public static final SexAction PERFORMING_clit_DOM_NORMAL = new SexAction(
			SexActionType.ONGOING,
			ArousalIncrease.FOUR_HIGH,
			ArousalIncrease.FOUR_HIGH,
			CorruptionLevel.ONE_VANILLA,
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				return "Pleasure [npc2.namePos] [npc2.clit+] with your [npc.breasts+].";
			} else {
				return "Pleasure [npc2.namePos] [npc2.clit+] with your flat chest.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Reaching up to happily push [npc.her] [npc.breasts+] together around [npc2.namePos] [npc2.clit+],"
						...
						"Eagerly wrapping [npc.her] [npc.breasts+] around [npc2.namePos] [npc2.clit+], [npc.name] energetically [npc.verb(lift)] them up and down,"
						...
						"Letting out [npc.a_moan+], [npc.name] happily [npc2.verb(push)] [npc.her] [npc.breasts+] together,"
								+ " enveloping [npc2.namePos] [npc2.clit+] in [npc.her] pillowy mounds as [npc.she] [npc.verb(give)] [npc2.herHim] an eager titfuck."));
				
			} else {
				if(Main.sex.getCharacterPerformingAction().hasBreasts()) {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to happily push [npc.her] [npc.breasts+] against the sides of [npc2.namePos] [npc2.clit+],"
							...
							"Eagerly pressing [npc.her] [npc.breastSize] [npc.breasts] against the sides of [npc2.namePos] [npc2.clit+], [npc.name] energetically [npc.verb(lift)] them up and down,"
					...
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to happily wrap [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+], [npc.name] enthusiastically [npc.verb(raise)] and [npc.verb(lower)] [npc.her] torso,"
									+ " [npc.moaning+] as [npc.she] [npc.verb(thrust)] out [npc.her] flat chest to desperately grind against [npc2.herHim].",

							"Eagerly wrapping [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+], [npc.name] energetically [npc.verb(lift)] [npc.her] torso up and down,"
									+ " grinding [npc.her] flat chest against [npc2.herHim] as [npc.she] [npc.verb(try)] to imitate giving [npc2.herHim] a titfuck.",

							"Letting out [npc.a_moan+], [npc.name] happily [npc.verb(wrap)] [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+],"
	...
	public static final SexAction PERFORMING_clit_DOM_ROUGH = new SexAction(
			SexActionType.ONGOING,
			ArousalIncrease.FOUR_HIGH,
			ArousalIncrease.FOUR_HIGH,
			CorruptionLevel.TWO_HORNY,
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				return "Roughly pleasure [npc2.namePos] [npc2.clit+] with your [npc.breasts+].";
			} else {
				return "Roughly pleasure [npc2.namePos] [npc2.clit+] with your flat chest.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Reaching up to roughly force [npc.her] [npc.breasts+] together around [npc2.namePos] [npc2.clit+],"
						...
						"Dominantly wrapping [npc.her] [npc.breasts+] around [npc2.namePos] [npc2.clit+], [npc.name] roughly [npc.verb(bounce)] them up and down,"
						...
						"Letting out [npc.a_moan+], [npc.name] forcefully [npc2.verb(push)] [npc.her] [npc.breasts+] together,"
								+ " enveloping [npc2.namePos] [npc2.clit+] in [npc.her] pillowy mounds as [npc.she] [npc.verb(give)] [npc2.herHim] a dominant titfuck."));
				
			} else {
				if(Main.sex.getCharacterPerformingAction().hasBreasts()) {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to roughly force [npc.her] [npc.breasts+] against the sides of [npc2.namePos] [npc2.clit+],"
							...
							"Dominantly pressing [npc.her] [npc.breastSize] [npc.breasts] against the sides of [npc2.namePos] [npc2.clit+], [npc.name] roughly [npc.verb(lift)] them up and down,"
					...
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to roughly wrap [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+], [npc.name] violently [npc.verb(raise)] and [npc.verb(lower)] [npc.her] torso,"
									+ " [npc.moaning+] as [npc.she] [npc.verb(thrust)] out [npc.her] flat chest to dominantly grind against [npc2.herHim].",

							"Dominantly wrapping [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+], [npc.name] roughly [npc.verb(lift)] [npc.her] torso up and down,"
									+ " grinding [npc.her] flat chest against [npc2.herHim] as [npc.she] [npc.verb(try)] to imitate giving [npc2.herHim] a titfuck.",

							"Letting out [npc.a_moan+], [npc.name] forcefully [npc.verb(wrap)] [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+],"
	...
	public static final SexAction PERFORMING_clit_SUB_NORMAL = new SexAction(
			SexActionType.ONGOING,
			ArousalIncrease.FOUR_HIGH,
			ArousalIncrease.FOUR_HIGH,
			CorruptionLevel.ONE_VANILLA,
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						...
						"Wrapping [npc.her] [npc.breasts+] around [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(lift)] them up and down,"
						...
						"Letting out [npc.a_moan+], [npc.name] [npc.verb(push)] [npc.her] [npc.breasts+] together,"
								+ " enveloping [npc2.namePos] [npc2.clit+] in [npc.her] pillowy mounds as [npc.she] [npc.verb(give)] [npc2.herHim] a titfuck."));
				...
				if(Main.sex.getCharacterPerformingAction().hasBreasts()) {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							"Pressing [npc.her] [npc.breastSize] [npc.breasts] against the sides of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(lift)] them up and down,"
					...
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to happily wrap [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(raise)] and [npc.verb(lower)] [npc.her] torso,"
									+ " [npc.moaning+] as [npc.she] [npc.verb(thrust)] out [npc.her] flat chest to grind against [npc2.herHim].",

							"Wrapping [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(lift)] [npc.her] torso up and down,"
									+ " grinding [npc.her] flat chest against [npc2.herHim] as [npc.she] [npc.verb(try)] to imitate giving [npc2.herHim] a titfuck.",

							"Letting out [npc.a_moan+], [npc.name] [npc.verb(wrap)] [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+],"
									+ " before thrusting [npc.her] flat chest out and giving [npc2.herHim] an imitation titfuck"));
				}
			}
	...
	public static final SexAction PERFORMING_clit_SUB_EAGER = new SexAction(
			SexActionType.ONGOING,
			ArousalIncrease.FOUR_HIGH,
			ArousalIncrease.FOUR_HIGH,
			CorruptionLevel.ONE_VANILLA,
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				return "Eagerly pleasure [npc2.namePos] [npc2.clit+] with your [npc.breasts+].";
			} else {
				return "Eagerly pleasure [npc2.namePos] [npc2.clit+] with your flat chest.";
			}
		}
	...
	public static final SexAction FUCKED_SUB_RESIST = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				return "Try and pull your [npc.breasts+] away from [npc2.namePos] [npc2.clit+].";
			} else {
				return "Try and pull your flat chest away from [npc2.namePos] [npc2.clit+].";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"[npc.Name] [npc.verb(let)] out [npc.moan+] as [npc.she] [npc.verb(try)] to pull [npc.her] [npc.breasts+] away from [npc2.namePos] [npc2.clit+],"
						...
						"With [npc.a_moan+], [npc.name] weakly [npc.verb(try)] to pull away from [npc2.name],"
								+ " sobbing in distress as [npc2.her] [npc2.clit+] continues to thrust up between [npc.her] [npc.breasts+].",

						"Letting out [npc.a_moan+], [npc.name] [npc.verb(try)] to push [npc2.name] away from [npc.herHim],"
								+ " tears running down [npc.her] cheeks as [npc2.she] [npc2.verb(continue)] thrusting [npc2.her] [npc2.clit+] into [npc.her] cleavage."));
				
			} else if(Main.sex.getCharacterPerformingAction().hasBreasts()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"[npc.Name] [npc.verb(let)] out [npc.moan+] as [npc.she] [npc.verb(try)] to pull [npc.her] [npc.breastSize] [npc.breasts] away from [npc2.namePos] [npc2.clit+],"
								+ " before begging for [npc.herHim] to leave [npc2.herHim] alone.",

						"With [npc.a_moan+], [npc.name] weakly [npc.verb(try)] to pull away from [npc2.name],"
								+ " sobbing in distress as [npc2.her] [npc2.clit+] continue to thrust up between [npc.her] [npc.breastSize] [npc.breasts+].",

						"Letting out [npc.a_moan+], [npc.name] [npc.verb(try)] to push [npc2.name] away from [npc.herHim],"
								+ " tears running down [npc.her] cheeks as [npc2.she] [npc2.verb(continue)] thrusting [npc2.her] [npc2.clit+] into [npc.her] small cleavage."));
						
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"[npc.Name] [npc.verb(let)] out [npc.moan+] as [npc.she] [npc.verb(try)] to pull [npc.her] flat chest away from [npc2.namePos] [npc2.clit+],"
								+ " before begging for [npc.herHim] to leave [npc2.herHim] alone.",

						"With [npc.a_moan+], [npc.name] weakly [npc.verb(try)] to pull away from [npc2.name],"
								+ " sobbing in distress as [npc2.her] [npc2.clit+] continues to grind up against [npc.her] flat chest.",

						"Letting out [npc.a_moan+], [npc.name] [npc.verb(try)] to push [npc2.name] away from [npc.herHim],"
								+ " tears running down [npc.her] cheeks as [npc2.she] [npc2.verb(continue)] thrusting [npc2.her] [npc2.clit+] against [npc.her] torso."));
			}
	...
	public static final SexAction FUCKED_STOP = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastFuckablePaizuri()) {
				return "Push [npc2.namePos] [npc2.clit] away from your [npc.breasts+].";
			} else {
				return "Push [npc2.namePos] [npc2.clit] away from your flat chest.";
			}
		}
