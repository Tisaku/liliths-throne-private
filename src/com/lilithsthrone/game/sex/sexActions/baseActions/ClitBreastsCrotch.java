 ...
 * @author Innoxia
 */
public class ClitBreastsCrotch {
	...
	public static final SexAction FUCKING_START = new SexAction(
			...
			Util.newHashMapOfValues(new Value<>(SexAreaPenetration.CLIT, SexAreaOrifice.BREAST_CROTCH)),
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckablePaizuri()) {
				return "Slide your [npc.clit+] between [npc2.namePos] [npc2.crotchBoobs+] and start fucking them.";
			} else {
				return "Start grinding your [npc.clit+] over [npc2.namePos] stomach.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckablePaizuri()) {
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to take hold of [npc2.namePos] [npc2.crotchBoobs+], [npc.name] gently [npc.verb(push)] them together,"
										+ " lining [npc.her] [npc.clit] up to [npc2.her] cleavage before sliding forwards and starting to fuck [npc2.her] [npc2.crotchBoobs]."));
						break;
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to greedily [npc.verb(sink)] [npc.her] [npc.fingers] into [npc2.namePos] [npc2.crotchBoobs+], [npc.name] eagerly [npc.verb(push)] them together,"
										+ " lining [npc.her] [npc.clit] up to [npc2.her] cleavage before sliding forwards and starting to enthusiastically fuck [npc2.her] [npc2.crotchBoobs]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to roughly [npc.verb(sink)] [npc.her] [npc.fingers] into [npc2.namePos] [npc2.crotchBoobs+], [npc.name] forcefully [npc.verb(push)] them together,"
										+ " lining [npc.her] [npc.clit] up to [npc2.her] cleavage before slamming forwards and starting to rapidly fuck [npc2.her] [npc2.crotchBoobs]."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to take hold of [npc2.namePos] [npc2.crotchBoobs+], [npc.name] gently [npc.verb(try)] to push them together,"
										+ " lining [npc.her] [npc.clit] up to what little cleavage [npc2.she] [npc2.has] before sliding forwards and starting to grind down over [npc2.her] lower abdomen."));
						break;
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to squeeze and grope [npc2.namePos] [npc2.crotchBoobs+], [npc.name] [npc.do] [npc.her] best to try to push them together,"
										+ " lining [npc.her] [npc.clit] up to what little cleavage [npc2.she] [npc2.has] before sliding forwards and starting to eagerly grind down over [npc2.her] lower abdomen."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to roughly squeeze and grope [npc2.namePos] [npc2.crotchBoobs+], [npc.name] [npc.do] [npc.her] best to try to push them together,"
										+ " lining [npc.her] [npc.clit] up to what little cleavage [npc2.she] [npc2.has] before sliding forwards and starting to forcefully grind down over [npc2.her] lower abdomen."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to squeeze and grope [npc2.namePos] [npc2.crotchBoobs+], [npc.name] [npc.do] [npc.her] best to try to push them together,"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to press [npc.her] [npc.hands] against [npc2.namePos] torso, [npc.name] repositions [npc.herself] to line [npc.her] [npc.clit] up over [npc2.her] lower abdomen,"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down to roughly [npc.verb(press)] [npc.her] [npc.hands] against [npc2.namePos] torso, [npc.name] repositions [npc.herself] to line [npc.her] [npc.clit] up over [npc2.her] lower abdomen,"
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] eagerly [npc2.verb(wrap)] [npc2.her] [npc2.crotchBoobs+] around [npc.namePos] [npc.clit+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] [npc2.verb(wrap)] [npc2.her] [npc2.crotchBoobs+] around [npc.namePos] [npc.clit+],"
									+ " before begging for [npc.herHim] to continue fucking [npc2.her] pillowy mounds."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] gently [npc2.verb(wrap)] [npc2.her] [npc2.crotchBoobs+] around [npc.namePos] [npc.clit+],"
									+ " before begging for [npc.herHim] to continue fucking [npc2.her] pillowy mounds."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] dominantly [npc2.verb(wrap)] [npc2.her] [npc2.crotchBoobs+] around [npc.namePos] [npc.clit+],"
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] eagerly [npc2.verb(push)] [npc2.her] [npc2.crotchBoobs+] against the sides of [npc.namePos] [npc.clit+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] [npc2.verb(push)] [npc2.her] [npc2.crotchBoobs+] against the sides of [npc.namePos] [npc.clit+],"
									+ " before begging for [npc.herHim] to continue fucking [npc2.her] diminutive cleavage."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] gently [npc2.verb(push)] [npc2.her] [npc2.crotchBoobs+] against the sides of [npc.namePos] [npc.clit+],"
									+ " before begging for [npc.herHim] to continue fucking [npc2.her] diminutive cleavage."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] dominantly [npc2.verb(press)] [npc2.her] [npc2.crotchBoobs+] against the sides of [npc.namePos] [npc.clit+],"
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] eagerly [npc2.does] [npc2.her] best to try and [npc2.verb(wrap)] [npc2.her] flat stomach around [npc.namePos] [npc.clit+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] [npc2.does] [npc2.her] best to try and [npc2.verb(wrap)] [npc2.her] flat stomach around [npc.namePos] [npc.clit+],"
									+ " before giving up and begging for [npc.herHim] to continue humping [npc2.her] torso."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] [npc2.does] [npc2.her] best to try and gently [npc2.verb(wrap)] [npc2.her] flat stomach around [npc.namePos] [npc.clit+],"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.Moaning] in delight, [npc2.name] [npc2.does] [npc2.her] best to try and roughly [npc2.verb(wrap)] [npc2.her] flat stomach around [npc.namePos] [npc.clit+],"
	...
	public static final SexAction FUCKING_DOM_GENTLE = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckablePaizuri()) {
				...
				return "Gently grind your [npc.clit+] against [npc2.namePos] flat stomach.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Gently sliding [npc.her] [npc.clit+] between [npc2.namePos] [npc2.crotchBoobs+],"
						...
						"Gently pushing [npc.her] [npc.clit+] between the cleavage formed between [npc2.namePos] [npc2.crotchBoobs+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Gently sliding [npc.her] [npc.clit+] between [npc2.namePos] tiny [npc2.crotchBoobs],"
						...
						"Gently pushing [npc.her] [npc.clit+] between the tiny amount of cleavage formed between [npc2.namePos] [npc2.crotchBoobs+],"
						...
						"Softly trying to push [npc2.namePos] [npc2.crotchBoobSize] [npc2.crotchBoobs] together, [npc.name] [npc.verb(let)] out a little [npc.moan] as [npc.she] [npc.verb(start)] to gently pump [npc.her] [npc.hips] back and forth,"
								+ " breathing in [npc2.her] [npc2.scent] as [npc.she] slowly [npc.verb(grind)] [npc.her] [npc.clit+] over [npc2.her] lower abdomen."));
				
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Gently sliding [npc.her] [npc.clit+] over [npc2.namePos] flat lower abdomen,"
						...
						"Gently pushing [npc.her] [npc.clit+] down against [npc2.namePos] flat [npc2.crotchBoobs],"
								+ " [npc.name] [npc.verb(start)] softly thrusting [npc.her] [npc.hips] forwards, letting out a little [npc.moan] as [npc.she] gently [npc.verb(grind)] up and down over [npc2.her] lower abdomen.",
	...
	public static final SexAction FUCKING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Eagerly sliding [npc.her] [npc.clit+] between [npc2.namePos] [npc2.crotchBoobs+],"
						...
						"Desperately pushing [npc.her] [npc.clit+] between the cleavage formed between [npc2.namePos] [npc2.crotchBoobs+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Eagerly sliding [npc.her] [npc.clit+] between [npc2.namePos] tiny [npc2.crotchBoobs],"
						...
						"Desperately pushing [npc.her] [npc.clit+] between the tiny amount of cleavage formed between [npc2.namePos] [npc2.crotchBoobs+],"
						...
						"Greedily trying to push [npc2.namePos] [npc2.crotchBoobSize] [npc2.crotchBoobs] together, [npc.name] [npc.verb(let)] out [npc.a_moan+] as [npc.she] [npc.verb(start)] to frantically pump [npc.her] [npc.hips] back and forth,"
								+ " breathing in [npc2.her] [npc2.scent] as [npc.she] eagerly [npc.verb(grind)] [npc.her] [npc.clit+] over [npc2.her] lower abdomen."));
				
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Eagerly sliding [npc.her] [npc.clit+] over [npc2.namePos] flat lower abdomen,"
						...
						"Desperately pushing [npc.her] [npc.clit+] down against [npc2.namePos] flat [npc2.crotchBoobs],"
								+ " [npc.name] [npc.verb(start)] energetically thrusting [npc.her] [npc.hips] forwards, letting out [npc.moans+] as [npc.she] happily [npc.verb(grind)] up and down over [npc2.her] lower abdomen.",
	...
	public static final SexAction FUCKING_DOM_ROUGH = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckablePaizuri()) {
				...
				return "Roughly grind your [npc.clit+] against [npc2.namePos] flat stomach.";
			}
		}
		@Override
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Roughly slamming [npc.her] [npc.clit+] between [npc2.namePos] [npc2.crotchBoobs+],"
						...
						"Violently pushing [npc.her] [npc.clit+] between the cleavage formed between [npc2.namePos] [npc2.crotchBoobs+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Roughly slamming [npc.her] [npc.clit+] between [npc2.namePos] tiny [npc2.crotchBoobs],"
						...
						"Violently pushing [npc.her] [npc.clit+] between the tiny amount of cleavage formed between [npc2.namePos] [npc2.crotchBoobs+],"
						...
						"Greedily trying to push [npc2.namePos] [npc2.crotchBoobSize] [npc2.crotchBoobs] together, [npc.name] [npc.verb(let)] out [npc.a_moan+] as [npc.she] [npc.verb(start)] to dominantly pump [npc.her] [npc.hips] back and forth,"
								+ " breathing in [npc2.her] [npc2.scent] as [npc.she] roughly [npc.verb(grind)] [npc.her] [npc.clit+] over [npc2.her] lower abdomen."));
				
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Roughly pushing [npc.her] [npc.clit+] over [npc2.namePos] flat lower abdomen,"
						...
						"Violently pushing [npc.her] [npc.clit+] down against [npc2.namePos] flat [npc2.crotchBoobs],"
								+ " [npc.name] [npc.verb(start)] roughly thrusting [npc.her] [npc.hips] forwards, letting out [npc.moans+] as [npc.she] dominantly [npc.verb(grind)] up and down over [npc2.her] lower abdomen.",
	...
	public static final SexAction FUCKING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Sliding [npc.her] [npc.clit+] between [npc2.namePos] [npc2.crotchBoobs+],"
						...
						"Pushing [npc.her] [npc.clit+] between the cleavage formed between [npc2.namePos] [npc2.crotchBoobs+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Sliding [npc.her] [npc.clit+] between [npc2.namePos] tiny [npc2.crotchBoobs],"
						...
						"Pushing [npc.her] [npc.clit+] between the tiny amount of cleavage formed between [npc2.namePos] [npc2.crotchBoobs+],"
						...
						"Trying to push [npc2.namePos] [npc2.crotchBoobSize] [npc2.crotchBoobs] together, [npc.name] [npc.verb(let)] out [npc.a_moan+] as [npc.she] [npc.verb(start)] to pump [npc.her] [npc.hips] back and forth,"
								+ " breathing in [npc2.her] [npc2.scent] as [npc.she] [npc.verb(grind)] [npc.her] [npc.clit+] over [npc2.her] lower abdomen."));
				
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Sliding [npc.her] [npc.clit+] over [npc2.namePos] flat lower abdomen,"
						...
						"Pushing [npc.her] [npc.clit+] down against [npc2.namePos] flat [npc2.crotchBoobs],"
								+ " [npc.name] [npc.verb(start)] thrusting [npc.her] [npc.hips] forwards, letting out [npc.moans+] as [npc.she] happily [npc.verb(grind)] up and down over [npc2.her] lower abdomen.",
	...
	public static final SexAction FUCKING_SUB_RESIST = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckablePaizuri()) {
				return "Try to pull your [npc.clit] away from [npc2.namePos] [npc2.crotchBoobs+].";
			} else {
				return "Try to pull your [npc.clit] away from [npc2.namePos] stomach.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckablePaizuri()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								"Tears start to well up in [npc.namePos] [npc.eyes] as [npc.she] [npc.verb(try)] to pull out of [npc2.namePos] cleavage, but [npc2.her] grip is too strong,"
										+ " and [npc2.she] [npc2.verb(continue)] softly [npc2.moaning] as [npc2.she] firmly [npc2.verb(force)] [npc.her] [npc.clit+] between [npc2.her] [npc2.crotchBoobs+]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								"Tears start to well up in [npc.namePos] [npc.eyes] as [npc.she] [npc.verb(try)] to pull out of [npc2.namePos] cleavage, but [npc2.her] grip is too strong,"
										+ " and [npc2.she] [npc2.verb(continue)] [npc2.moaning+] as [npc2.she] roughly [npc2.verb(force)] [npc.her] [npc.clit+] between [npc2.her] [npc2.crotchBoobs+]."));
						break;
					default: // DOM_NORMAL and in case anything goes wrong:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								"Tears start to well up in [npc.namePos] [npc.eyes] as [npc.she] [npc.verb(try)] to pull out of [npc2.namePos] cleavage, but [npc2.her] grip is too strong,"
										+ " and [npc2.she] [npc2.verb(continue)] [npc2.moaning+] as [npc2.she] eagerly [npc2.verb(force)] [npc.her] [npc.clit+] between [npc2.her] [npc2.crotchBoobs+]."));
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] desperately [npc.verb(try)] to pull [npc.her] [npc.clit+] away from [npc2.namePos] flat lower abdomen, but [npc2.she] firmly [npc2.verb(hold)] [npc.herHim] in place,"
								...
								"Tears start to well up in [npc.namePos] [npc.eyes] as [npc.she] [npc.verb(try)] to pull away from [npc2.name], but [npc2.her] grip is too strong,"
										+ " and [npc2.she] [npc2.verb(continue)] softly [npc2.moaning] as [npc2.she] firmly [npc2.verb(force)] [npc.her] [npc.clit+] against [npc2.her] lower abdomen."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] desperately [npc.verb(try)] to pull [npc.her] [npc.clit+] away from [npc2.namePos] lower abdomen, but [npc2.she] roughly [npc2.verb(hold)] [npc.herHim] in place,"
								...
								"Tears start to well up in [npc.namePos] [npc.eyes] as [npc.she] [npc.verb(try)] to pull away from [npc2.name], but [npc2.her] grip is too strong,"
										+ " and [npc2.she] [npc2.verb(continue)] [npc2.moaning+] as [npc2.she] roughly [npc2.verb(force)] [npc.namePos] [npc.clit+] against [npc2.her] lower abdomen."));
						break;
					default: // DOM_NORMAL and in case anything goes wrong:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] desperately [npc.verb(try)] to pull [npc.her] [npc.clit+] away from [npc2.namePos] lower abdomen, but [npc2.name] firmly [npc2.verb(hold)] [npc.herHim] in place,"
								...
								"Tears start to well up in [npc.namePos] [npc.eyes] as [npc.she] [npc.verb(try)] to pull away from [npc2.name], but [npc2.her] grip is too strong,"
										+ " and [npc2.she] [npc2.verb(continue)] [npc2.moaning+] as [npc2.she] eagerly [npc2.verb(force)] [npc.her] [npc.clit+] against [npc2.her] lower abdomen."));
						break;
				}
			}
	...
	public static final SexAction FUCKING_STOP = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckablePaizuri()) {
				return "Pull your [npc.clit+] away from [npc2.namePos] [npc2.crotchBoobs+] and stop fucking them.";
			} else {
				return "Pull your [npc.clit+] away from [npc2.namePos] lower abdomen and stop grinding against [npc2.herHim].";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckablePaizuri()) {
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly pushing [npc2.name] away,"
										+ " [npc.name] [npc.verb(pull)] [npc.her] [npc.clit+] out from [npc2.her] cleavage and [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of fucking [npc2.her] [npc2.crotchBoobs+].",

								"Roughly pulling [npc.her] [npc.clit+] out from [npc2.namePos] cleavage, [npc.name] [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of fucking [npc2.her] [npc2.crotchBoobs+]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.name] [npc.verb(pull)] [npc.her] [npc.clit+] out from [npc2.namePos] cleavage and [npc.verb(tell)] [npc2.name] that [npc.sheHas] had enough of fucking [npc2.her] [npc2.crotchBoobs+].",

								"Pulling [npc.her] [npc.clit+] out from [npc2.namePos] cleavage, [npc.name] [npc.verb(tell)] [npc2.name] that [npc.sheHas] had enough of fucking [npc2.her] [npc2.crotchBoobs+]."));
						break;
				}
			} else if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchSize().getMeasurement()>=CupSize.AA.getMeasurement()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly pushing [npc2.name] away, [npc.name] takes [npc.her] [npc.clit+] away from [npc2.her] lower abdomen and [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of grinding against [npc2.herHim].",

								"Roughly pulling [npc.her] [npc.clit+] away from [npc2.namePos] lower abdomen, [npc.name] [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of grinding against [npc2.herHim]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] takes [npc.her] [npc.clit+] away from [npc2.namePos] lower abdomen and [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of grinding against [npc2.herHim].",

								"Pulling [npc.her] [npc.clit+] away from [npc2.namePos] lower abdomen, [npc.name] [npc.verb(tell)] [npc2.herHim] that [npc.sheHas] had enough of grinding against [npc2.herHim]."));
						break;
				}
			}
	...
	public static final SexAction USING_CLIT_START = new SexAction(
			...
			ArousalIncrease.FOUR_HIGH,
			CorruptionLevel.ONE_VANILLA,
			Util.newHashMapOfValues(new Value<>(SexAreaOrifice.BREAST_CROTCH, SexAreaPenetration.CLIT)),
			SexParticipantType.NORMAL) {
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				return "Use [npc2.namePos] [npc2.clit+] to fuck your [npc.crotchBoobs+].";
			} else {
				return "Use [npc2.namePos] [npc2.clit+] to grind against your lower abdomen.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Gently taking hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to [npc.her] flat lower abdomen, and, sliding forwards,"
										+ " [npc.she] [npc.verb(grind)] [npc.her] torso against [npc2.her] [npc2.clit+]."));
						break;
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Eagerly taking hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to [npc.her] flat lower abdomen, and, sliding forwards,"
										+ " [npc.she] enthusiastically [npc.verb(grind)] [npc.her] torso against [npc2.her] [npc2.clit+]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly grabbing hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to [npc.her] flat lower abdomen, and, sliding forwards,"
										+ " [npc.she] forcefully [npc.verb(grind)] [npc.her] torso against [npc2.her] [npc2.clit+]."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Taking hold of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(guide)] it up to [npc.her] flat lower abdomen, and, sliding forwards,"
										+ " [npc.she] [npc.verb(grind)] [npc.her] torso against [npc2.her] [npc2.clit+]."));
						break;
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
	...
	private static String getTargetedCharacterReceivingResponse(SexAction action) {
		if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] greedily [npc2.verb(thrust)] [npc2.her] [npc2.clit+] deep between [npc.namePos] [npc.crotchBoobs+],"
									+ " letting out [npc2.a_moan+] as [npc2.she] enthusiastically [npc2.verb(fuck)] [npc.her] cleavage.",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] thrusting [npc2.her] [npc2.clit+] deep between [npc.namePos] [npc.crotchBoobs+].",
									
							" [npc2.Moaning] in delight, [npc2.name] eagerly [npc2.verb(drive)] [npc2.her] [npc2.clit+] in and out between [npc.namePos] [npc.crotchBoobs+]."));
					break;
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" Failing to pull [npc2.her] [npc2.clit] away from [npc.namePos] [npc.crotchBoobs+],"
									+ " [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc2.she] weakly [npc2.verb(try)] to struggle free.",
		
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
									+ " squirming and protesting as [npc.name] [npc.verb(continue)] to force [npc2.her] [npc2.clit+] back and forth between [npc.her] [npc.crotchBoobs+].",
		
							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to pull [npc2.her] [npc2.clit] away from [npc.namePos] [npc.crotchBoobs+]."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] gently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] between [npc.namePos] [npc.crotchBoobs+],"
									+ " letting out a soft [npc2.moan] as [npc2.she] [npc2.verb(fuck)] [npc.her] cleavage.",
		
							" A soft [npc2.moan] drifts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] gently thrusting [npc2.her] [npc2.clit+] between [npc.namePos] [npc.crotchBoobs+].",
									
							" [npc2.Moaning] in delight, [npc2.name] gently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] back and forth between [npc.namePos] [npc.crotchBoobs+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] violently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] deep between [npc.namePos] [npc.crotchBoobs+],"
									+ " letting out [npc2.a_moan+] as [npc2.she] roughly [npc2.verb(fuck)] [npc.her] cleavage.",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] roughly slamming [npc2.her] [npc2.clit+] deep between [npc.namePos] [npc.crotchBoobs+].",
									
							" [npc2.Moaning] in delight, [npc2.name] roughly [npc2.verb(slam)] [npc2.her] [npc2.clit+] back and forth between [npc.namePos] [npc.crotchBoobs+]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(thrust)] [npc2.her] [npc2.clit+] deep between [npc.namePos] [npc.crotchBoobs+],"
									+ " letting out [npc2.a_moan+] as [npc2.she] [npc2.verb(fuck)] [npc.her] cleavage.",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] thrusting [npc2.her] [npc2.clit+] deep between [npc.namePos] [npc.crotchBoobs+].",
									
							" [npc2.Moaning] in delight, [npc2.name] [npc2.verb(drive)] [npc2.her] [npc2.clit+] back and forth between [npc.namePos] [npc.crotchBoobs+]."));
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] thrusting [npc2.her] [npc2.clit+] between [npc.namePos] [npc.crotchBoobSize] [npc.crotchBoobs].",
									
							" [npc2.Moaning] in delight, [npc2.name] eagerly [npc2.verb(drive)] [npc2.her] [npc2.clit+] in and out of the diminutive cleavage formed between [npc.namePos] [npc.crotchBoobs+]."));
					break;
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" Failing to pull [npc2.her] [npc2.clit] away from [npc.namePos] [npc.crotchBoobs+],"
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" A soft [npc2.moan] drifts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] gently thrusting [npc2.her] [npc2.clit+] between [npc.namePos]  [npc.crotchBoobSize] [npc.crotchBoobs].",
									
							" [npc2.Moaning] in delight, [npc2.name] gently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] in and out of the diminutive cleavage formed between [npc.namePos] [npc.crotchBoobs+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] roughly slamming [npc2.her] [npc2.clit+] between  [npc.crotchBoobSize] [npc.crotchBoobs].",
									
							" [npc2.Moaning] in delight, [npc2.name] roughly [npc2.verb(slam)] [npc2.her] [npc2.clit+] in and out of the diminutive cleavage formed between [npc.namePos] [npc.crotchBoobs+]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] thrusting [npc2.her] [npc2.clit+] between  [npc.crotchBoobSize] [npc.crotchBoobs].",
									
							" [npc2.Moaning] in delight, [npc2.name] [npc2.verb(drive)] [npc2.her] [npc2.clit+] in and out of the diminutive cleavage formed between [npc.namePos] [npc.crotchBoobs+]."));
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] greedily [npc2.verb(thrust)] [npc2.her] [npc2.clit+] over [npc.namePos] flat stomach,"
									+ " letting out [npc2.a_moan+] as [npc2.she] enthusiastically [npc2.verb(grind)] against [npc.her] torso.",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] thrusting [npc2.her] [npc2.clit+] up and down against [npc.namePos] flat stomach.",
									
							" [npc2.Moaning] in delight, [npc2.name] eagerly [npc2.verb(grind)] [npc2.her] [npc2.clit+] over [npc.namePos] flat stomach."));
					break;
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" Failing to pull [npc2.her] [npc2.clit] away from [npc.namePos] flat stomach,"
									+ " [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc2.she] weakly [npc2.verb(try)] to struggle free.",
		
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
									+ " squirming and protesting as [npc.name] [npc.verb(continue)] to force [npc2.her] [npc2.clit+] back and forth over [npc.her] flat stomach.",
		
							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to pull [npc2.her] [npc2.clit] away from [npc.namePos] flat stomach."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] gently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] over [npc.namePos] flat stomach,"
									+ " letting out a soft [npc2.moan] as [npc2.she] [npc2.verb(grind)] against [npc.her] torso.",
		
							" A soft [npc2.moan] drifts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] gently thrusting [npc2.her] [npc2.clit+] up and down against [npc.namePos] flat stomach.",
									
							" [npc2.Moaning] in delight, [npc2.name] gently [npc2.verb(grind)] [npc2.her] [npc2.clit+] over [npc.namePos] flat stomach."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] violently [npc2.verb(thrust)] [npc2.her] [npc2.clit+] over [npc.namePos] flat stomach,"
									+ " letting out [npc2.a_moan+] as [npc2.she] roughly [npc2.verb(grind)] against [npc.her] torso.",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] roughly slamming [npc2.her] [npc2.clit+] up and down against [npc.namePos] flat stomach.",
									
							" [npc2.Moaning] in delight, [npc2.name] roughly [npc2.verb(grind)] [npc2.her] [npc2.clit+] over [npc.namePos] flat stomach."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(thrust)] [npc2.her] [npc2.clit+] over [npc.namePos] flat stomach,"
									+ " letting out [npc2.a_moan+] as [npc2.she] [npc2.verb(grind)] against [npc.her] torso.",
		
							" [npc2.A_moan+] bursts out from [npc2.namePos] mouth, before [npc2.she] [npc2.verb(start)] thrusting [npc2.her] [npc2.clit+] up and down against [npc.namePos] flat stomach.",
									
							" [npc2.Moaning] in delight, [npc2.name] [npc2.verb(grind)] [npc2.her] [npc2.clit+] over [npc.namePos] flat stomach."));
					break;
			}
		}
		return "";
	...
	public static final SexAction PERFORMING_CLIT_DOM_GENTLE = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				return "Gently pleasure [npc2.namePos] [npc2.clit+] with your [npc.crotchBoobs+].";
			} else {
				return "Gently pleasure [npc2.namePos] [npc2.clit+] with your stomach.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Reaching up to push [npc.her] [npc.crotchBoobs+] together around [npc2.namePos] [npc2.clit+],"
						...
						"Gently wrapping [npc.her] [npc.crotchBoobs+] around [npc2.namePos] [npc2.clit+], [npc.name] slowly [npc.verb(lift)] them up and down,"
				...
				if(Main.sex.getCharacterPerformingAction().getBreastCrotchSize().getMeasurement()>=CupSize.AA.getMeasurement()) {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to push [npc.her] [npc.crotchBoobs+] against the sides of [npc2.namePos] [npc2.clit+],"
							...
							"Gently pressing [npc.her] [npc.crotchBoobSize] [npc.crotchBoobs] against the sides of [npc2.namePos] [npc2.clit+], [npc.name] slowly [npc.verb(lift)] them up and down,"
					...
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to wrap [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+], [npc.name] gently [npc.verb(raise)] and [npc.verb(lower)] [npc.namePos] torso,"
	...
	public static final SexAction PERFORMING_CLIT_DOM_NORMAL = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				return "Pleasure [npc2.namePos] [npc2.clit+] with your [npc.crotchBoobs+].";
			} else {
				return "Pleasure [npc2.namePos] [npc2.clit+] with your flat stomach.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Reaching up to happily push [npc.her] [npc.crotchBoobs+] together around [npc2.namePos] [npc2.clit+],"
						...
						"Eagerly wrapping [npc.her] [npc.crotchBoobs+] around [npc2.namePos] [npc2.clit+], [npc.name] energetically [npc.verb(lift)] them up and down,"
				...
				if(Main.sex.getCharacterPerformingAction().getBreastCrotchSize().getMeasurement()>=CupSize.AA.getMeasurement()) {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to happily push [npc.her] [npc.crotchBoobs+] against the sides of [npc2.namePos] [npc2.clit+],"
							...
							"Eagerly pressing [npc.her] [npc.crotchBoobSize] [npc.crotchBoobs] against the sides of [npc2.namePos] [npc2.clit+], [npc.name] energetically [npc.verb(lift)] them up and down,"
					...
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to happily wrap [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+], [npc.name] enthusiastically [npc.verb(raise)] and [npc.verb(lower)] [npc.namePos] torso,"
	...
	public static final SexAction PERFORMING_CLIT_DOM_ROUGH = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				return "Roughly pleasure [npc2.namePos] [npc2.clit+] with your [npc.crotchBoobs+].";
			} else {
				return "Roughly pleasure [npc2.namePos] [npc2.clit+] with your flat stomach.";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Reaching up to roughly force [npc.her] [npc.crotchBoobs+] together around [npc2.namePos] [npc2.clit+],"
						...
						"Dominantly wrapping [npc.her] [npc.crotchBoobs+] around [npc2.namePos] [npc2.clit+], [npc.name] roughly [npc.verb(bounce)] them up and down,"
				...
				if(Main.sex.getCharacterPerformingAction().getBreastCrotchSize().getMeasurement()>=CupSize.AA.getMeasurement()) {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to roughly force [npc.her] [npc.crotchBoobs+] against the sides of [npc2.namePos] [npc2.clit+],"
							...
							"Dominantly pressing [npc.her] [npc.crotchBoobSize] [npc.crotchBoobs] against the sides of [npc2.namePos] [npc2.clit+], [npc.name] roughly [npc.verb(lift)] them up and down,"
					...
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to roughly wrap [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+], [npc.name] violently [npc.verb(raise)] and [npc.verb(lower)] [npc.namePos] torso,"
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						...
						"Wrapping [npc.her] [npc.crotchBoobs+] around [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(lift)] them up and down,"
				...
				if(Main.sex.getCharacterPerformingAction().getBreastCrotchSize().getMeasurement()>=CupSize.AA.getMeasurement()) {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							"Pressing [npc.her] [npc.crotchBoobSize] [npc.crotchBoobs] against the sides of [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(lift)] them up and down,"
					...
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to happily wrap [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.clit+], [npc.name] [npc.verb(raise)] and [npc.verb(lower)] [npc.namePos] torso,"
	...
	public static final SexAction PERFORMING_CLIT_SUB_EAGER = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				return "Eagerly pleasure [npc2.namePos] [npc2.clit+] with your [npc.crotchBoobs+].";
			} else {
				return "Eagerly pleasure [npc2.namePos] [npc2.clit+] with your flat stomach.";
			}
		}
	...
	public static final SexAction FUCKED_SUB_RESIST = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				return "Try and pull your [npc.crotchBoobs+] away from [npc2.namePos] [npc2.clit+].";
			} else {
				return "Try and pull your flat stomach away from [npc2.namePos] [npc2.clit+].";
			}
		}
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"[npc.Name] [npc.verb(let)] out [npc.moan+] as [npc.she] [npc.verb(try)] to pull [npc.her] [npc.crotchBoobs+] away from [npc2.namePos] [npc2.clit+],"
						...
						"With [npc.a_moan+], [npc.name] weakly [npc.verb(try)] to pull away from [npc2.name],"
								+ " sobbing in distress as [npc2.her] [npc2.clit+] continues to thrust up between [npc.her] [npc.crotchBoobs+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"[npc.Name] [npc.verb(let)] out [npc.moan+] as [npc.she] [npc.verb(try)] to pull [npc.her] [npc.crotchBoobSize] [npc.crotchBoobs] away from [npc2.namePos] [npc2.clit+],"
								+ " before begging for [npc.herHim] to leave [npc2.herHim] alone.",

						"With [npc.a_moan+], [npc.name] weakly [npc.verb(try)] to pull away from [npc2.name],"
								+ " sobbing in distress as [npc2.her] [npc2.clit+] continue to thrust up between [npc.her] [npc.crotchBoobSize] [npc.crotchBoobs+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"[npc.Name] [npc.verb(let)] out [npc.moan+] as [npc.she] [npc.verb(try)] to pull [npc.her] flat lower abdomen away from [npc2.namePos] [npc2.clit+],"
								+ " before begging for [npc.herHim] to leave [npc2.herHim] alone.",

						"With [npc.a_moan+], [npc.name] weakly [npc.verb(try)] to pull away from [npc2.name],"
								+ " sobbing in distress as [npc2.her] [npc2.clit+] continues to grind up against [npc.her] flat lower abdomen.",
	...
	public static final SexAction FUCKED_STOP = new SexAction(
		...
		public String getActionDescription() {
			if(Main.sex.getCharacterPerformingAction().isBreastCrotchFuckablePaizuri()) {
				return "Push [npc2.namePos] [npc2.clit] away from your [npc.crotchBoobs+].";
			} else {
				return "Push [npc2.namePos] [npc2.clit] away from your flat stomach.";
			}
		}
